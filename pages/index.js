    ...
    <>
      ...
      <main>
        ...
        <section className="about">
          ...
          <p>
            Google Maps Directions Link Generator lets you quickly enter a
            business name or address, then will generate a link for you to get
            directions from Google Maps to that location.
          </p>
          <p>
          ...
          <p className="example example-good">
            1 Infinite Loop, Cupertino, CA 95014
          </p>
          <p className="example-helper">
          ...
          <p className="example-helper">
            ...
            cases. Unless there are more than one "Wall Street" in that city,
            then Google will make a best guess.
          </p>

          <h3 className="header-bad">Bad</h3>
          <p className="example example-bad">McDonalds, Los Angeles 90016</p>
          <p className="example-helper">
            This is too generic. Google will not be able to effectively
            determine which McDonalds you are referring to since there are
            likely multiple McDonalds in a zip code.
          </p>
        </section>
      </main>
